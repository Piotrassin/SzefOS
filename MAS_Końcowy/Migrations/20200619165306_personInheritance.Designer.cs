...
namespace MAS_Końcowy.Migrations
{
    ...
    [Migration("20200619165306_personInheritance")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAS_Końcowy.Model.Contract", b =>
                {
                    ...
                    b.Property<int?>("IngredientsSupplierId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IngredientsSupplierId");
            ...
            modelBuilder.Entity("MAS_Końcowy.Model.Contract", b =>
                {
                    b.HasOne("MAS_Końcowy.Model.IngredientsSupplier", null)
                        .WithMany("Contracts")
                        .HasForeignKey("IngredientsSupplierId");
                });
            ...
            modelBuilder.Entity("MAS_Końcowy.Model.Person", b =>
                {
                    b.HasOne("MAS_Końcowy.Model.Address", "Address")
                        .WithMany()
