...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAS_Końcowy.Model.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MAS_Końcowy.Model.Cook", b =>
                {
                    b.HasOne("MAS_Końcowy.Model.Employee", "Employee")
                        .WithOne("Cook")
                        .HasForeignKey("MAS_Końcowy.Model.Cook", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MAS_Końcowy.Model.Deliverer", b =>
                {
                    b.HasOne("MAS_Końcowy.Model.Employee", "Employee")
                        .WithOne("Deliverer")
                        .HasForeignKey("MAS_Końcowy.Model.Deliverer", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MAS_Końcowy.Model.Manager", b =>
                {
                    b.HasOne("MAS_Końcowy.Model.Employee", "Employee")
                        .WithOne("Manager")
                        .HasForeignKey("MAS_Końcowy.Model.Manager", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MAS_Końcowy.Model.Waiter", b =>
                {
                    b.HasOne("MAS_Końcowy.Model.Employee", "Employee")
                        .WithOne("Waiter")
                        .HasForeignKey("MAS_Końcowy.Model.Waiter", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
